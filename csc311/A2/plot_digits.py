...
data_small = np.load("mnist_train_small.npz")
print(data_small.files)
print(data_small['train_inputs_small'].shape)
print(data_small['train_targets_small'])
# plot_digits(data_small['train_inputs_small'])

data = np.load("mnist_train.npz")
print(data.files)
# plot_digits(data['train_inputs'])